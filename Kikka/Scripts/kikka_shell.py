...
class Surface:
    ...
    ENUM_VALENTINE = 28         # 情人节 / バレンタイン
    ENUM_HAPPINESS = 29         # 幸福 / 幸せ
    ENUM_SIDEWAYS = 30          # 侧身 / 横向き
    ENUM_FIVESEVEN = 32         # FiveseveN / FiveseveN
    ENUM_SURPRISE2 = 33         # 惊讶 / 驚き
    ENUM_KNIFE = 34             # 刀 / ナイフ
    ENUM_ENDURE = 35            # 抵抗 / 耐え
    ENUM_SLOUCH = 40            # 鞠躬 / 前屈み
    ENUM_SLOUCH_JOY = 41        # 喜悦(鞠躬) / 喜び（前屈み）
    ...
    ENUM_KERO_NORMAL = 10       # 正常 / 素
    ENUM_KERO_SIDEWAYS = 11     # 侧身 / 横
    ENUM_KERO_FRONT = 12        # 正面 / 正面
    ENUM_KERO_TURNING = 13      # 转头 / 转头
